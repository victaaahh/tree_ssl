...
class BaseDataset:
    def __init__(self, dataset_opt):
        ...
        transforms = dataset_opt.get(dataset_opt.transform_type)
        if "pre_transform" in dataset_opt:
            transforms["pre_transform"] = dataset_opt.get("pre_transform")
        BaseDataset.set_transform(self, transforms)
    ...
    def resolve_saving_stage(self, selection_stage):
        ...
        if selection_stage == "":
            if self.has_val_loader:
                ...
                selection_stage = self.train_dataset.name
        log.info(
